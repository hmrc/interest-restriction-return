...
**Request Schema:** [Json Schema](resources/public/api/conf/1.0/v1.schemas/appointReportingCompanySchema.json)
...
**Request Schema:** [Json Schema](resources/public/api/conf/1.0/v1.schemas/revokeReportingCompanySchema.json)
...
**Request Schema:** [Json Schema](resources/public/api/conf/1.0/v1.schemas/abbreviatedReturnSchema.json)
...
**Request Schema:** [Json Schema](resources/public/api/conf/1.0/v1.schemas/fullReturnSchema.json)
