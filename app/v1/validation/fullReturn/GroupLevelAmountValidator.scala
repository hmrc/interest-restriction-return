  ...
  def validate(implicit path: JsPath): ValidationResult[GroupLevelAmountModel]                             =
    (
      validatePositive(
        ...
        ReactivationCapCannotBeNegative(groupLevelAmount.interestReactivationCap)
      ),
      validateDecimalPlaces(
        groupLevelAmount.interestReactivationCap,
        ReactivationCapDecimalError(groupLevelAmount.interestReactivationCap)
      ),
      validatePositive(
        groupLevelAmount.interestAllowanceForPeriod,
        InterestAllowanceForPeriodCannotBeNegative(groupLevelAmount.interestAllowanceForPeriod)
      ),
      validateDecimalPlaces(
        groupLevelAmount.interestAllowanceForPeriod,
        InterestAllowanceForPeriodDecimalError(groupLevelAmount.interestAllowanceForPeriod)
      ),
      validatePositive(
        groupLevelAmount.interestAllowanceBroughtForward,
      ...
      validatePositive(
        groupLevelAmount.interestCapacityForPeriod,
        InterestCapacityForPeriodCannotBeNegative(groupLevelAmount.interestCapacityForPeriod)
      ),
      validateDecimalPlaces(
        groupLevelAmount.interestCapacityForPeriod,
        InterestCapacityForPeriodDecimalError(groupLevelAmount.interestCapacityForPeriod)
      )
