...
import connectors.httpParsers.AppointReportingCompanyHttpParser.{ErrorResponse, SuccessResponse, UnexpectedFailure}
...
class AppointReportingCompanyConnectorSpec extends MockHttpClient with BaseSpec {
  ...
  "AppointReportingCompanyConnector.appoint" when {
    ...
    def setup(response: Either[ErrorResponse, SuccessResponse]): AppointReportingCompanyConnector = {
